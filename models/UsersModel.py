...
class Order(Base):
    ...
    id_user = Column(Integer, ForeignKey('users.id_user'), nullable=False)
    id_payment = Column(Integer, ForeignKey('payment_methods.id_payment'), nullable=False)
...
class Saving(Base):
    ...
    id_saving = Column(Integer, primary_key=True, autoincrement=True)
    id_user = Column(Integer, ForeignKey('users.id_user'), nullable=False)
    id_order = Column(Integer, ForeignKey('orders.id_order'), nullable=False)
...
class InterestHistory(Base):
    ...
    id_interest = Column(Integer, primary_key=True, autoincrement=True)
    id_user = Column(Integer, ForeignKey('users.id_user'), nullable=False)
